...
The `home-routes` handler in the `love-pop.routes.home` namespace
...
The `home-page` function will in turn call the `love-pop.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/love_pop/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `love-pop.handler` namespace:
...
Request middleware functions are located under the `love_pop.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `love-pop.dev-middleware` namespace found in
